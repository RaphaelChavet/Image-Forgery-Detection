...
parser.add_argument('-in', '--input', type=str, default='assets/input_images',
                    help='can be a single file, a directory or a glob statement')
parser.add_argument('-out', '--output', type=str, default='assets/results/npz/', help='output folder')
